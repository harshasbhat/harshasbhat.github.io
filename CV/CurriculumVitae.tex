...
\usepackage[a4paper,left=2.75cm,right=2.25cm, bottom=3.5cm, top=2.5cm]{geometry}
\input{preamble.tex}
\usepackage{fontspec}
...
\hfill \textit{École Normale Supérieure, Paris}\\[2.0cm]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subtitlea{EDUCATION}{
\vspace{-2pt}
\noindent\begin{tabular*}{\textwidth}{c @{\extracolsep{\fill}} llll} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textbf{\color{BrickRed} ~\textit{{Undergraduate Students : 6 weeks long research internship}}}\\[-1pt]
\setlist{nolistsep}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textbf{\color{BrickRed} ~\textit{{Masters Students : 4-6 month long research internship}}}\\[-1pt]
\setlist{nolistsep}
\begin{description}[labelindent=16pt ,labelwidth=2cm, labelsep*=2pt, itemsep=6pt, leftmargin =!, style = standard]%
