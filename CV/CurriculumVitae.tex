...
\definecolor{mycolor}{rgb}{0.02, 0.435, 0.698}% Rule colour
...
%\mytriangleb Date of birth: 11 Feb. 1980, Bombay, India\\[3pt]
%\mytriangleb Nationality: INDIAN\\[3pt]
%\mytriangleb URL: \url{https://harshasbhat.github.io}}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subtitlea{EDUCATION}{\small
\vspace{-2pt}
\begin{tabular*}{\textwidth}{c @{\extracolsep{\fill}} llll} 
{2007/06} & {\bf Ph.D.} & {\it Mechanical Sciences} & {\bf Harvard University, USA} \\[3pt]
{2002/06} & {\bf M. S.} & {\it Engineering Sciences} & {\bf Harvard University, USA}  
\end{tabular*}
}
\vspace{-5pt}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subtitlea{CURRENT POSITION}{\small
\begin{tabular}{l l l}
{\it \mytriangleb École Normale Supérieure, France} & {2016/05~\mytriangle{Black}{-90}} Present&
\it CNRS Research Scientist \\[4pt]
{\it \mytriangleb California Institute of Technology, USA} & {2018/12~\mytriangle{Black}{-90}} Present&
\it Visiting Professor in Aeronautics
\end{tabular}
}
\subtitlea{PAST POSITIONS}{\small
\begin{tabular}{l l l}
{\it \mytriangleb Institut de Physique du Globe de Paris, France} & {2012/01~\mytriangle{Black}{-90}~2016/05}&
\it CNRS Research Scientist \\[4pt]
{\it \mytriangleb University of Southern California, USA} & {2010/03~\mytriangle{Black}{-90}~2011/12}&
\it Assistant Professor (Research)  \\[4pt]
{\it \mytriangleb University of Southern California, USA} & {2007/11~\mytriangle{Black}{-90}~2010/03}&
\it Post Doctoral Fellow  \\[4pt]
{\it \mytriangleb California Institute of Technology, USA} & {2007/11~\mytriangle{Black}{-90}~2010/03}&
\it Visitor in Aeronautics \\[4pt]
{\it \mytriangleb Harvard University, USA} & {2007/05~\mytriangle{Black}{-90}~2007/10}&
\it Post Doctoral Fellow \\[4pt]
{\it \mytriangleb Harvard University, USA} & {2001/11~\mytriangle{Black}{-90}~2007/05}&
\it Graduate Research Associate
\end{tabular}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%BrickRed%%%%%%%%%%%%%
\subtitlea{GRANTS}{ 
\vspace{-5pt}
\mytriangleb 2 Million Euros, ERC Consolidator Grant, PERSISMO (865411), Jan 1, 2021-Dec 31, 2025 
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%BrickRed%%%%%%%%%%%%%
\subtitlea{HONORS AND AWARDS}{ 
\vspace{-5pt}
\mytriangleb 2018 CNRS Award for Doctoral Supervision and Research\\
\mytriangleb 2018 Grand Prix Michel Gouilloud Schlumberger, French Academy of Sciences\\
\mytriangleb 2003, 2004 \& 2006 Harvard University Certiﬁcate of Distinction in Teaching 
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{enumerate*}}
{\it \hfill $\dagger$ Classes taught with various colleagues at Harvard, Caltech, IPGP and ENS}\\[10pt]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subtitlea{ORGANISATION OF SCIENTIFIC MEETINGS}{
\vspace{-5pt}
\mytriangleb June 2019: Coupled Processes In Fracture Propagation In Geo-Materials: From Hydraulic Fractures To Earthquakes: CISM Advanced School, Udine, Italy\\
\mytriangleb April 2015: Seismological Society of America, Multiscale Modeling and Characterization of Fragmentation and Damage Patterns in Fault Zones\\
\mytriangleb December 2014: American Geophysical Union, Fault Zone Properties And Processes During Dynamic Ruptures
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subtitlea{INSTITUTIONAL RESPONSIBILITIES}{
\vspace{-5pt}
\mytriangleb 2018 Onwards: Team Leader of Faults \& Earthquakes Group, ENS {(\it11 Researchers, 8 postdocs and 8 PhD students)}\\[2pt]
\mytriangleb 2018-2019: Co-organizer of the Internal Seminar, ENS
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subtitle{BOOKS}
\vspace{-15pt}
...
\vspace{-5pt}
\mytriangleb American Geophysical Union\\[2pt]
\mytriangleb European Geophysical Union
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subtitlea{STUDENTS \& POSTDOCS}{\vspace{0.1cm}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textbf{\color{BrickRed} ~\textit{\large {Undergraduate Students : 6 weeks long research internship}}}\\[-10pt]
\setlist{nolistsep}
\begin{description}[labelindent=16pt ,labelwidth=2cm, labelsep*=2pt, leftmargin =!, style = standard]%
\item[\mytriangleb Phillipe Danre (2017)] Étude de l’impact des marées sur le glissement sismique et asismique des failles actives \textit{(Co-advised with Dr. R. Jolivet, ENS)}
\item[\mytriangleb Hugo Lestrelin (2019)] Theoretical investigation of radiation from a size distribution of fractures\textit{(Co-advised with Dr. L. Bruhat, ENS)}
\item[\mytriangleb Roxane Ferry (2019)] Understanding the relationship between Slow Slip accélérations observed in natural and synthetic GPS \textit{(Co-advised with Dr. J. Jara, ENS)}\\[-5pt]\end{description}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textbf{\color{BrickRed} ~\textit{\large {Masters Students : 4-6 month long research internship}}}\\[-10pt]
\setlist{nolistsep}
\begin{description}[labelindent=16pt ,labelwidth=2cm, labelsep*=2pt, leftmargin =!, style = standard]%
\item[\mytriangleb Sonia Fliss (2003)] Fault branching and rupture directivity \textit{(Co-advised with Prof. J. R. Rice \& Dr. R. Dmowska, Harvard)}
\item[\mytriangleb Marion Olives (2004)] Finite fault branches and rupture dynamics: Is it time to look more carefully at fault maps? \textit{(Co-advised with Prof. J. R. Rice \& Dr. R. Dmowska, Harvard)}
\item[\mytriangleb Aurelie Baudet (2004)] Finite element modeling of laboratory experiments on impact and shear rupture of pre-faulted specimens \textit{(Co-advised with Prof. J. R. Rice \& Dr. E. L. Templeton, Harvard)}
