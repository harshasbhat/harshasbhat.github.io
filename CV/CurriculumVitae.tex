...
\setlist[description]{%
  font={\bfseries\sffamily\color{mygray}}, % set the label font
}
...
\hfill {\Large \color{BrickRed}\LARGE \textbf{Harsha}} {\Large \color{BrickRed}\LARGE \textit{Suresh}} {\Large \color{BrickRed}\LARGE \textbf{Bhat}} \\[-15pt]

\hfill \textit{\color{BrickRed} Chargé de Recherche de Classe Normale, CNRS}\\[-15pt]

\hfill \textit{\color{BrickRed} École Normale Supérieure, Paris}\\[1.5cm]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subtitlea{PERSONAL INFORMATION}{\small
\vspace{-2pt}
\mytriangleb Address: Laboratoire de Géologie, 24 Rue Lhomond, 75005, Paris, France\\[3pt]
\mytriangleb Nationality: Indian\\[3pt]
\mytriangleb Website: \url{https://harshasbhat.github.io}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subtitlea{EDUCATION}{\small
\vspace{-2pt}
\begin{tabular*}{\textwidth}{c @{\extracolsep{\fill}} llll} 
{2007/06} & { Ph. D.} & {\it Mechanical Sciences} & { Harvard University, USA} \\[3pt]
{2002/06} & { M. S.} & {\it Engineering Sciences} & { Harvard University, USA} \\[3pt] 
{2001/06} & { B. E.} & {\it Civil Engineering} & { NITK, India}
\end{tabular*}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textbf{\color{BrickRed} ~\textit{\large {Undergraduate Students : 6 weeks long research internship}}}\\[-1pt]
\setlist{nolistsep}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textbf{\color{BrickRed} ~\textit{\large {Masters Students : 4-6 month long research internship}}}\\[-1pt]
\setlist{nolistsep}
\begin{description}[labelindent=16pt ,labelwidth=2cm, labelsep*=2pt, itemsep=8pt, leftmargin =!, style = standard]%
