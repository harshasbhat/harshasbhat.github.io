...
\renewcommand\fbox{\fcolorbox{BrickRed}{white}}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\newcommand{\subtitle}[1]{
{\textbf{\textcolor{BrickRed}{}}}\xrfill[0pt]{0.5pt}[BrickRed]\\[-2pt]
\fbox{\textbf{\textcolor{BrickRed}{#1 ~}}}\\[5pt]
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\newcommand{\subtitlea}[2]{
{\textbf{\textcolor{BrickRed}{}}}\xrfill[0pt]{0.5pt}[BrickRed]\\[-5pt]
\fbox{\textbf{\textcolor{BrickRed}{#1 ~}}}\\[2pt]
...
\DeclareFieldFormat
  ...
  {title}{\mkbibquote{\textcolor{Black}{\textit{#1}}\isdot}}
\AtEveryBibitem{
%\clearfield{year}
\clearfield{volume}
\clearfield{number}
