...
# Path to your institutional letterhead image (PNG/JPG/SVG).
# Set to the actual file path or a URL.
# Leave blank to show the text header instead.
letterhead-image: "combinedlogoEN.png"
header-includes: |
  <meta name="viewport" content="width=device-width, initial-scale=1.0">

# Path to your .bib file (absolute or relative to cv.md)
bibliography: /Users/bhat/PcloudPublicFolder/CollectedPapers/MasterBibliography.bib

# CSL style — author-year matches your LaTeX authoryear biblatex style.
# Download from https://www.zotero.org/styles/author-year
# or use the bundled chicago-author-date, apa, etc.
csl: author-year.csl

# nocite: forces all listed keys to appear in the bibliography
# even though they are not cited in the body text.
# Pandoc/citeproc will respect these exactly as \nocite{} did in LaTeX.
nocite: |
  @thomas2017a, @bizzarri2012,
  @thomas2022a, @thomas2022b,
  @kheirdast2026, @garagash2026, @gupta2026, @cheng2026, @zhou2026,
  @wang2026, @almakari2026, @melkior2025b, @michel2026, @latour2025,
...
[† Habilitation à Diriger des Recherches — * Supervised by Prof. J. R. Rice & Dr. R. Dmowska]{.footnote}
...
- 2021–2025 ▸ 2M€ ERC Consolidator Grant, PERSISMO (Grant No. 865411)
- 2023–2027 ▸ 100k€ ANR SMEC
- 2023–2026 ▸ 100k€ ANR Univ. Tokyo SESAME
- 2023–2025 ▸ 66k€ SPARC Grant India
- 2018 ▸ 25k€ ENS Actions Incitatives
- 2017 ▸ 6k€ TelluS INSU — action ALEAS
...
| [Thomas Melkior (France)]{.current} | 2023–2026 | |
| [Caiyuan Fan (China)]{.current} | 2023–2027 | |
...
[† Classes taught with various colleagues at Harvard, Caltech, IPGP, ENS]{.footnote}

# ORGANIZATION OF SCIENTIFIC MEETINGS

- **Jan 2026:** Earthquake Source: Mechanics, Seismology and Geology Workshop — NISER, India
- **Apr 2024:** Across the time scales, from earthquakes to earthquake cycle — EGU 2024
- **Apr 2023:** Across the time scales, from earthquakes to earthquake cycle — EGU 2023
...
<!-- Keys included via nocite: @thomas2017a, @bizzarri2012 -->
...
<!-- Keys included via nocite: @thomas2022a, @thomas2022b -->

# PUBLICATIONS

Google Scholar: [ZHskR34AAAAJ](https://scholar.google.com/citations?user=ZHskR34AAAAJ) · ORCID: [0000-0003-0361-1854](https://orcid.org/0000-0003-0361-1854)

::: {#refs}
:::

<!-- All keys listed in the nocite: field in the YAML header above. -->
