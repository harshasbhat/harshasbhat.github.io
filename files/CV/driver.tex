...
{\textbf{\textcolor{groy}{{#1}}}}\\[-8pt]\hrule\noindent
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\newcommand{\subsubtitle}[1]{
{\hfill \textbf{\textcolor{black}{\ul{\bf #1}}}}\\[-5pt]
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\newcommand{\subtitlea}[2]{
{\textbf{\textcolor{groy}{{#1}}}}\\[-8pt]
\hrule
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[backend=bibtex,dashed=false,doi=true,natbib=true,isbn=false,url=false,style=authoryear,maxbibnames=99,maxnames=10,maxcitenames=2,sorting=none,sortcites=false,giveninits=true]{biblatex}
\renewbibmacro{in:}{}
\DeclareFieldFormat
