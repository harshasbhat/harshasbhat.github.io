...
\definecolor{groy}{RGB}{78,136,199}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[firstinits=true,backend=bibtex,doi=true,natbib=true,isbn=false,url=false,style=authoryear,maxbibnames=99,maxnames=10,maxcitenames=2,sorting=none,sortcites=false]{biblatex}
\renewbibmacro{in:}{}
\DeclareFieldFormat
